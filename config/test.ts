...
const {PORT, MONGO_DB_URI, SALT_WORK_FACTOR, ACCESS_TOKEN_TTL, REFRESH_TOKEN_TTL, METRICS_PORT} = process.env;

export default {
    PORT:  parseInt(PORT || '8181'),
    ...
    METRICS_PORT: parseInt(METRICS_PORT || '9191')
};

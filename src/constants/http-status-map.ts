...
const partialContent: HTTPStatus = {
    code: 206,
...
const movedPermanently: HTTPStatus = {
    code: 301,
...
const useProxy: HTTPStatus = {
    code: 305,
    message: 'Use Proxy',
    description: '*deprecated*',
};
const temporaryRedirect: HTTPStatus = {
    code: 307,
...
const permanentRedirect: HTTPStatus = {
    code: 308,
    message: 'Permanent Redirect',
    description: 'The target resource has been assigned a new permanent URI and any future references to this resource outght to use one of the enclosed URIs. [...] This status code is similar to 301 Moved Permanently (Section 7.3.2 of rfc7231), except that it does not allow rewriting the request method from POST to GET.',
};
const badRequest: HTTPStatus = {
    code: 400,
    message: 'Bad Request',
...
const paymentRequired: HTTPStatus = {
    code: 402,
...
const methodNotAllowed: HTTPStatus = {
    code: 405,
...
const notAcceptable: HTTPStatus = {
    code: 406,
...
const proxyAuthenticationRequired: HTTPStatus = {
    code: 407,
...
const requestTimeout: HTTPStatus = {
    code: 408,
...
const payloadTooLarge: HTTPStatus = {
    code: 413,
...
const unsupportedMediaType: HTTPStatus = {
    code: 415,
...
const rangeNotSatisfiable: HTTPStatus = {
    code: 416,
...
const expectationFailed: HTTPStatus = {
    code: 417,
...
const upgradeRequired: HTTPStatus = {
    code: 426,
...
const internalServerError: HTTPStatus = {
    code: 500,
...
const serviceUnavailable: HTTPStatus = {
    code: 503,
...
const gatewayTimeOut: HTTPStatus = {
    code: 504,
...
const httpVersionNotSupported: HTTPStatus = {
    code: 505,
...
const variantAlsoNegotiates: HTTPStatus = {
    code: 506,
...
const insufficientStorage: HTTPStatus = {
    code: 507,
...
const networkAuthenticationRequired: HTTPStatus = {
    code: 511,
